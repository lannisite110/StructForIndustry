...
pub use mock_vision::run_mock_vision_sidecar;
pub use out_process::{
...
pub use plugin_wire::{
    encode_request, BBox, Detection, FrameRef, Metric, TaskRequest, TaskResponse,
    WIRE_API_VERSION,
};
pub use supervisor::{
    plugin_health_event_bytes, HealthReport, OutProcessSpec, PluginSupervisor,
};
