...
SFI_OPCUA_MOCK=1 \
SFI_OPCUA_POLL_MS=50 \
SFI_BUS_SOCKET="$BUS_SOCK" \
SFI_LINE_SHM="$SHM_NAME" \
cargo run -q --manifest-path domains/industrial-inspection/hal-ext/opcua-plc-trigger/Cargo.toml &
OPCUA_PID=$!
